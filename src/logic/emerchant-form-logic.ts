...
export function addEmerchantFormProps(props: IFormSettings) {
        ...
        handlers: {
            ...
            async onFormSubmit(formState: IFormState) {
                ...
                try {
                    ...
                    const response = await fetch('/Umbraco/Api/EmerchantApplication/Post', {
                        method: "POST",
                        mode: "cors",
...
export function addDevEmerchantFormProps(props: IFormSettings) {
