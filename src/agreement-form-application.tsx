...
import { addDevAgreementFormProps, addAgreementFormProps } from "./logic/agreement-form-logic";
...
import(/* webpackChunkName: "form-builder" */ "./components/form-builder").then(({ FormBuilder }) => {
    ...
    const el = document.querySelector(selectors.agreementForm).children[0] as HTMLElement;
    ...
    if (process.env.NODE_ENV === "production") {
        ...
        json = addDevAgreementFormProps(json);
    }

    const props: IFormBuilderProps = addAgreementFormProps(json);
